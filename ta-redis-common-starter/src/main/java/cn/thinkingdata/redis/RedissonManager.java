package cn.thinkingdata.redis;

import cn.thinkingdata.redis.config.RedissonProperties;
import cn.thinkingdata.redis.config.strategy.RedissonConfigContext;
import cn.thinkingdata.redis.config.strategy.impl.ClusterRedissonConfigStrategyImpl;
import cn.thinkingdata.redis.config.strategy.impl.MasterslaveRedissonConfigStrategyImpl;
import cn.thinkingdata.redis.config.strategy.impl.SentinelRedissonConfigStrategyImpl;
import cn.thinkingdata.redis.config.strategy.impl.StandaloneRedissonConfigStrategyImpl;
import cn.thinkingdata.redis.constant.RedisConnectionType;
...
/**
 * class_name: RedissonManager
 * package: cn.thinkingdata.redis
 * describe: Redisson核心配置，用于提供初始化的redisson实例
